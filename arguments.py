...
default_values = {'out': 'result', 'root': 'data', 'btoa': False, 'train': '__train__', 'val': '__test__', 'from_col': [0], 'to_col': [1], 'imgtype': 'jpg', \
    ...
    'ch': None, 'out_ch': None, 'model_enc': None, 'mode_dec': None}
...
def arguments():
    ...
    parser.add_argument('--model_enc', '-me', help='specify a learnt encoder/generator model file')
    parser.add_argument('--model_dec', '-md', help='specify a learnt encoder/generator model file')
    parser.add_argument('--model_dis', '-mc', default='', help='specify a learnt discriminator model file')
